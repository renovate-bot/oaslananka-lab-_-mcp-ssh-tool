...
function printHelp() {
  ...
  const help = [
    ...
    "  Enroll remote agent: npx --yes --package mcp-ssh-tool@latest mcp-ssh-agent enroll --server <url> --token <token> --alias <alias>",
    "  Run remote agent: npx --yes --package mcp-ssh-tool@latest mcp-ssh-agent run",
